...
blue2wite_dict = {'red': [(0.0, 0.0, 235 / 255),
                          (1., 52 / 255, 52 / 255)],

                  'green': [(0.0, 0.0, 245 / 255),
                            (1.0, 152 / 255, 152 / 255)],

                  'blue': [(0.0, 0.0, 251 / 255),
                           (1.0, 219 / 255, 219 / 255), ]}

blue_bar = mpl.colors.LinearSegmentedColormap('BlueBar', blue2wite_dict)
...
def crate_linerbar(c0: Union[str, tuple], c1: Union[str, tuple],
                   name: Optional[str]=None):
    """
    Crate two color user defined colorbar
    ...
    if isinstance(c1, str):
        c1 = hex_to_rgb(c1)
    c0 = (i / 255 for i in c0)
    c1 = (i / 255 for i in c1)
    colordict = {'red': [(0.0, 0.0, c0[0]),
                          (1., c1[0], c1[0])],
                  ...
                  'blue': [(0.0, 0.0, c0[2]),
                           (1.0, c1[2], c1[2]), ]}
    return mpl.colors.LinearSegmentedColormap(name, colordict)
