...
from CellMD3D_visulization.CellMD3D_utility import loadAllCells
...
file_ps = r'Y:\Data_Raid\sunhui_code_ret\ssa_in26_colony_RunBatch.7.46\Cells'

All_cells = loadAllCells(file_ps)
for cellsi, cells in enumerate(All_cells):
    ...
    fig1_colony_bottom.savefig(os.path.join(os.path.dirname(file_ps), f'{cellsi}_Colony_bottom.svg'))
